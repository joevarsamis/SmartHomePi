...
while True:
		...
		time.sleep(5)
			...
			xively.Datastream(id='outside_temperature', current_value= "%.1f" % currently.temperature, at=now),
                        xively.Datastream(id='outside_humidity', current_value=  "%.1f" %(currently.humidity * 100) , at=now),
